...
module.exports = async (deployer, network, [defaultAccount]) => {
    ...
    if (network.startsWith('rinkeby')) {
        await deployer.deploy(CryptoLlama, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
        let cnl = await CryptoLlama.deployed()
        ...
        // await deployer.deploy(CryptoLlama)
        // let cnl = await CryptoLlama.deployed()
    }
}
